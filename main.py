...
while True:
    ...
    if pilih == "1":
        ...
        if dua_dimensi == "1":
            ...
            print(persegipanjang(panjang_pp, lebar_pp)) #import peregi panjang
            ...
            print(jajargenjang(alas_jg, tinggi_jg)) #import jajar genjang
        ...
        else: print("======Pilih menu yang sesuai======")
